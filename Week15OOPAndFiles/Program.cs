...
{
    string[] tempArray = line.Split(new char[] {';'}, StringSplitOptions.RemoveEmptyEntries);//StringSplitOptions.RemoveEmptyEntries - eemaldab tühikud
...
{
    string filePath = @"D:\Kool\ProgrammeerimiseAlgkursus\Data\movies.txt";
